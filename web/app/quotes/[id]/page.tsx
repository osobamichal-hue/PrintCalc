  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      <div className="flex items-center justify-between gap-4">
        ...
        <Link href="/quotes" className="text-sm text-sky-400 hover:underline">
          ← Seznam
        </Link>
      </div>
      {msg && (
      ...
      <div className="space-y-2">
        ...
        {data.lines.map((l, i) => (
          ...
          >
            ...
            <button
              type="button"
              className="sm:col-span-1 text-xs text-red-400"
